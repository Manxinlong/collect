...
public class FFT {
    public static final int FFT_N = 4096;//4096
...
//        Log.i("FFT","s: "+str);
        ...
        double[] sf = new double[FFT_N/2];
        for (int i = 0; i <FFT_N/2; i++) {
            sf[i] = i*(double)SAMPLE_RATE / FFT_N;
//            Log.i("FFT","signaling frequency:"+sf[i]);
        }
